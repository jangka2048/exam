...
CREATE TABLE `markets_market`( 
    `market_id` INT(100) NOT NULL AUTO_INCREMENT PRIMARY KEY, -- 연결된 업체번호
...
CREATE TABLE `products_product_opt`(
  `ppo_id` INT(100) NOT NULL AUTO_INCREMENT PRIMARY KEY, -- 상품번호
  `ppo_size` CHAR(10) NOT NULL, -- 상품 사이즈
  `ppo_color` CHAR(10) NOT NULL, -- 상품 색
  `ppo_rest` INT(100) NOT NULL -- 남은 상품
);
